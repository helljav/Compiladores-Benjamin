...
class Uami(object):
    ...
    def crearArchivos( self ):
        ...
        self.urlCI = urlDist +  nombreFuente + ".obj"
        ...
        # Texto Default para el archivo tupla
        textoCI = [
                        "En este archivo se encuentran el codigo intermedio",
                        "\n\n"
                     ]
        ...
        self.escribirArchivo( self.urlCI, "w+", textoCI )
        self.ventana.escribirAreaCI( self.getArchivoTexto(self.urlCI) )
